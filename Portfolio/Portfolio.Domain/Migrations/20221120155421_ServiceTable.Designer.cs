...
namespace Portfolio.Domain.Migrations
{
    ...
    [Migration("20221120155421_ServiceTable")]
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Person", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 20, 15, 54, 21, 295, DateTimeKind.Utc).AddTicks(3326));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 29,
                            CareerLevel = "Teacher",
                            CreatedDate = new DateTime(2022, 11, 20, 19, 54, 21, 290, DateTimeKind.Local).AddTicks(3121),
                            Degree = "Master",
