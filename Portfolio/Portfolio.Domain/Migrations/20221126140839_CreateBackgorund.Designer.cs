...
namespace Portfolio.Domain.Migrations
{
    ...
    [Migration("20221126140839_CreateBackgorund")]
    partial class CreateBackgorund
    {
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Person", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 26, 14, 8, 39, 122, DateTimeKind.Utc).AddTicks(193));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 29,
                            CareerLevel = "Teacher",
                            CreatedDate = new DateTime(2022, 11, 26, 18, 8, 39, 118, DateTimeKind.Local).AddTicks(9531),
                            Degree = "Master",
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Service", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 26, 14, 8, 39, 131, DateTimeKind.Utc).AddTicks(4516));
