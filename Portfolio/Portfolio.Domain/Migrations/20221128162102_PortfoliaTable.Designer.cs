...
namespace Portfolio.Domain.Migrations
{
    ...
    [Migration("20221128162102_PortfoliaTable")]
    partial class PortfoliaTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Person", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 28, 16, 21, 1, 886, DateTimeKind.Utc).AddTicks(7205));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 29,
                            CareerLevel = "Teacher",
                            CreatedDate = new DateTime(2022, 11, 28, 20, 21, 1, 883, DateTimeKind.Local).AddTicks(6728),
                            Degree = "Master",
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Service", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 28, 16, 21, 1, 891, DateTimeKind.Utc).AddTicks(1767));
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Entites.Portfolia", b =>
                {
                    b.HasOne("Portfolio.Domain.Models.Entites.Category", "Categories")
                        .WithMany("Portfolias")
