...
namespace Portfolio.Domain.Migrations
{
    ...
    [Migration("20221130120635_appuser")]
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Person", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 30, 12, 6, 34, 819, DateTimeKind.Utc).AddTicks(230));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 29,
                            CareerLevel = "Teacher",
                            CreatedDate = new DateTime(2022, 11, 30, 16, 6, 34, 816, DateTimeKind.Local).AddTicks(9374),
                            Degree = "Master",
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Service", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 30, 12, 6, 34, 823, DateTimeKind.Utc).AddTicks(4949));
