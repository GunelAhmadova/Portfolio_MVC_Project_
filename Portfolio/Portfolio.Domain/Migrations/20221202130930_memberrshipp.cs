...
{
    public partial class memberrshipp : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundLevel = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 12, 2, 13, 9, 29, 722, DateTimeKind.Utc).AddTicks(1222)),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 12, 2, 13, 9, 29, 726, DateTimeKind.Utc).AddTicks(63)),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "People",
                columns: new[] { "Id", "Age", "Bio", "CareerLevel", "CreatedDate", "Degree", "DeletedDate", "Email", "Experiences", "Fax", "Location", "Name", "Phone", "Website" },
                values: new object[] { 1, 29, null, "Teacher", new DateTime(2022, 12, 2, 17, 9, 29, 720, DateTimeKind.Local).AddTicks(1866), "Master", null, "gunelaa@code.edu.az", null, null, "Azerbaijan", "Gunel", "055-462-26-34", "IGunel.com" });
