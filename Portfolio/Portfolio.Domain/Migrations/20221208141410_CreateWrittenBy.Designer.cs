...
namespace Portfolio.Domain.Migrations
{
    ...
    [Migration("20221208141410_CreateWrittenBy")]
    partial class CreateWrittenBy
    {
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Person", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 8, 14, 14, 9, 983, DateTimeKind.Utc).AddTicks(3202));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 29,
                            CareerLevel = "Teacher",
                            CreatedDate = new DateTime(2022, 12, 8, 18, 14, 9, 978, DateTimeKind.Local).AddTicks(5942),
                            Degree = "Master",
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Service", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 8, 14, 14, 9, 993, DateTimeKind.Utc).AddTicks(3250));
